...
const BackgroundPattern = () => (
    <div className="absolute inset-0 overflow-hidden">
        ...
        <div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-orange-500/5 rounded-full blur-3xl"/>
    </div>
);
...
const MainContent = () => {
    ...
    return (
        <main className="bg-gray-800 flex-1 h-screen relative flex flex-col   md:flex
            ...
            <div className="relative z-10 flex flex-col h-full min-w-0">
                ...
                <div className="h-[60px] xs:h-[65px] sm:h-[70px] md:h-[75px] lg:h-[80px] xl:h-[85px] 2xl:h-[90px] 3xl:h-[95px] 4xl:h-[100px] 5xl:h-[105px]
                    ...
                    <div className="flex items-center flex-shrink-0
                        ...
                        <button className="w-7 h-7 xs:w-8 xs:h-8 sm:w-8 sm:h-8 md:w-9 md:h-9 lg:w-9 lg:h-9 xl:w-10 xl:h-10 2xl:w-11 2xl:h-11 3xl:w-12 3xl:h-12 4xl:w-13 4xl:h-13 5xl:w-14 5xl:h-14
                            ...
                            <Bell size={14}
                                  className="text-gray-400 xs:w-[15px] xs:h-[15px] sm:w-4 sm:h-4 md:w-[16px] md:h-[16px] lg:w-4 lg:h-4 xl:w-5 xl:h-5 2xl:w-6 2xl:h-6 3xl:w-7 3xl:h-7 4xl:w-8 4xl:h-8 5xl:w-9 5xl:h-9"/>
                        </button>
                ...
                <span
                    className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl">
                  messages will here
                </span>
                        </div>
                            ...
                            <div className="gap-2 xs:gap-2.5 sm:gap-3 md:gap-3 lg:gap-3 xl:gap-3.5 2xl:gap-4 3xl:gap-5 4xl:gap-6 5xl:gap-7
                               ...
                               bg-gray-700/50 backdrop-blur-sm rounded-xl border border-gray-600/50 min-w-0"
                                ...
                                <button className="text-gray-400 hover:text-purple-400 transition-colors flex-shrink-0">
                                    <Paperclip size={16}
                                               className="xs:w-[17px] xs:h-[17px] sm:w-[18px] sm:h-[18px] md:w-[19px] md:h-[19px] lg:w-5 lg:h-5 xl:w-6 xl:h-6 2xl:w-7 2xl:h-7 3xl:w-8 3xl:h-8 4xl:w-9 4xl:h-9 5xl:w-10 5xl:h-10"/>
                                </button>
                                ...
                                >
                                    <Send size={14}
                                          className="xs:w-[15px] xs:h-[15px] sm:w-4 sm:h-4 md:w-[16px] md:h-[16px] lg:w-4 lg:h-4 xl:w-5 xl:h-5 2xl:w-6 2xl:h-6 3xl:w-7 3xl:h-7 4xl:w-8 4xl:h-8 5xl:w-9 5xl:h-9"/>
                                </button>
                            </div>
                        </div>
                    </div>
